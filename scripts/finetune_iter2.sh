...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=2 --main_process_port 2950 spin/run_spin_seed_llama_lora.py configs/config_seed_llama_iter2.yaml --learning_rate=1.0e-7 --beta=0.1 --warmup_ratio=0.1 --num_train_epochs=3 --output_dir="/data/checkpoints/t2i_dpo/spin/seed_llama_hf/iter2-ckpt"
