...
# instruction (Please generate an image.) variation ver. (구현중)
...
def main():
    ...
    "Please design the image.",
    "Please produce a photo of the image.",
    "Please generate the image.",
    "Please draw a painting of the image.",
    "I'd like to see a drawing of the image.",
    "I'd love to see an illustration of the image.",
    "I'd like to view the image.",
    "I want to see the image.",
    "I would like to see a photo of the image.",
    "Show me the image.",
    ...
    "Can you produce the image?",
    "Can you generate the image?",
    "Can you depict the image?",
    "Can you show me an illustration of the image?"
    ]
    
    p_idx = random.randint(0,19)
    instruction = gen_prompt[p_idx] # 'Please generate an image.'
