...
parser.add_argument('--input_dir', type=str, default='data_seed_llama/generated_imp_1/iter0')
parser.add_argument('--output_dir', type=str, default='data_seed_llama/synthetic_imp_1/iter0')
